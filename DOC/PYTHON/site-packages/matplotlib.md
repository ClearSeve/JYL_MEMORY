...
plt.plot(x, y1, marker='o', mec='r', mfc='w',label=u'曲线1')
plt.plot(x, y2, marker='*', ms=10,label=u'y=曲线2')
plt.legend()
#生成X的别名（X实时显示失效）
...
Y=np.array(Y)
Z=[[-0.58617619,-0.9712778,-0.7568025,-0.9712778 ],[-0.9712778,0.30807174,0.90929743,0.30807174],[-0.7568025,0.90929743,0.30807174,0.90929743],[-0.9712778,0.30807174,0.90929743,0.30807174]]
Z=np.array(Z)
